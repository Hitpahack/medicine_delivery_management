...
import { DistributorListBaseOnItemComponent } from './pharmacy/views/purchaseorder/dislistbaseonItem.component';
...
export const routes: Routes = [
  ...
  // This routing for Pharmacy panel...
  {
    ...
    children: [
      ...
      { path: 'itemdistrlist/:id', component: DistributorListBaseOnItemComponent,canActivate: [AuthGuardService], data: { module: 'purchasemanagement' }},
